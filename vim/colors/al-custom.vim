...
call <sid>hi('typescriptConditional',      s:base0E, '',       '',          '')
call <sid>hi('typescriptRepeat',           s:base0E, '',       '',          '')
call <sid>hi('typescriptBranch',           s:base0E, '',       '',          '')
call <sid>hi('typescriptLabel',            s:base0E, '',       '',          '')
call <sid>hi('typescriptStatement',        s:base0E, '',       '',          '')
call <sid>hi('typescriptIdentifier',       s:base0E, '',       '',          '')

call <sid>hi('ReactLifeCycleMethods',      s:base0D, '',       '',          '')
