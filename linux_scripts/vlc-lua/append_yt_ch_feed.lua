...
function descriptor()
	return {
		...
		license = "GPL",
		shortdesc = NAME,
		description = "Append YouTube channel feed to playlist.m3u8",
		url = nil,
		capabilities = {},
	}
end
...
<b>channelName</b> For aesthetical reasons.<br/>
<b>channelId</b> Unique channel id. Can be found in urls like<br/>
https://www.youtube.com/channel/{channelId}<br/>
...
<b>[Append]</b> Appends channel to playlist.<br/>
<b>[Clear]</b> Clears channel entries from this dialog.
]]
...
function activate()
  ...
  local tnames = {"channelName", "channelId", "playlistPath"}
